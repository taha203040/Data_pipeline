...
- **Fraud Detection**: Real-time validation with Redis-based rate limiting (Basic detection , smart one with ML Soon)
...
graph TB
    ...
    style Producer fill:#667EEA,stroke:#5A67D8,color:#FFFFFF
    style Consumer fill:#F093FB,stroke:#D53F8C,color:#FFFFFF
    style Kafka fill:#F6AD55,stroke:#ED8936,color:#FFFFFF
    style Redis fill:#FC8181,stroke:#E53E3E,color:#FFFFFF
    style PostgreSQL fill:#68D391,stroke:#38A169,color:#FFFFFF
    style DLQConsumer fill:#F687B3,stroke:#D53F8C,color:#FFFFFF
    style Prometheus fill:#F6AD55,stroke:#ED8936,color:#FFFFFF
```
...
export class TransactionsService {
  constructor(@Inject("NEW_TOPIC_PRODUCER") private producer: Producer) {}
...
```typescript
await pRetry(() => this.processTransaction(dto, retryContext), {
  retries: 3,
  minTimeout: 3000,
  maxTimeout: 5000,
});
